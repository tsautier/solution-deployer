...
unzip -o tenants/shared/7.2.zip 'sdwan-advpn-reference-release-7.2/bgp-on-loopback-multi-vrf/*.j2' -d tenants/shared/
...
echo ---------------------------
unzip -o -j ../projects.zip 'projects/CustomerB/Project.j2' -d tenants/CustomerB
...
echo ---------------------------------------
ORCH_TENANT=CustomerB ./autodeploy.py
